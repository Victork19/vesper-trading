...
class DecisionRecord(BaseModel):
    ...
    source:str='manual'; model_version:str|None=None; quality_score:float=1; snapshot_hash:str|None=None; observed_at:str|None=None; quote_observed_at:str|None=None; book_sequence:int|None=None
